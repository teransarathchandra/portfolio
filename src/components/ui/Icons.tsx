/**
 * Lightweight inline SVG icons for the portfolio.
 * Each icon accepts standard SVG props via the wrapper.
 * aria-hidden is set by default since these are decorative
 * alongside text labels or aria-label on parent.
 */
