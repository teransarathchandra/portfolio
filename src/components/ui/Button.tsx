...
const variants: Record<Variant, string> = {
  primary:
    'bg-accent text-background font-semibold hover:neon-glow-sm hover:brightness-110 focus-visible:neon-glow-sm',
  secondary:
    'border border-accent/30 text-accent hover:bg-accent-dim hover:border-accent/60',
  ghost:
