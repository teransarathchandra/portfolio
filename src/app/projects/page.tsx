        ...
        <div className="space-y-8">
          {projects.map((project) => (
            ...
            >
              ...
              <p className="mb-4 text-sm text-secondary-text">{project.description}</p>
              ...
              <div className="flex gap-3">
                {project.github && (
                  <Button href={project.github} variant="ghost" size="sm" target="_blank" rel="noopener noreferrer">
                    GitHub
                  </Button>
                )}
                {project.live && (
                  <Button href={project.live} variant="secondary" size="sm" target="_blank" rel="noopener noreferrer">
                    Live Demo
                  </Button>
                )}
              </div>
